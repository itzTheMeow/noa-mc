...
function MeshParticleSystem(capacity, rate, scene, startColor, uRange, vRange) {
  ...
  this._color0 = new Color4(startColor.r, startColor.g, startColor.b, startColor.a);
  this._color1 = new Color4(startColor.r, startColor.g, startColor.b, startColor.a);
...
MPS.prototype.setTexture = function setTexture(texture, material) {
  if (material) {
    ...
    this.material = new StandardMaterial("MPS-mat", this._scene);
...
function recalculateBounds(system) {
  ...
  system.mesh._boundingInfo = new BoundingInfo(min, max);
}
...
function updatePositionsData(system) {
  ...
  system.mesh.updateVerticesData(VertexBuffer.PositionKind, positions, false, false);
}
